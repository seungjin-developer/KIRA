...
features:
  ...
  - icon: 🔒
    title: 프라이버시 우선
    details: 모든 데이터와 메모리는 로컬에 저장됩니다 — 제3자 서비스 개입 없음. 당신의 API 키, 당신의 데이터, 당신의 통제.

  - icon: 🔑
    title: 나만의 API 키 사용
    details: 본인의 Claude API 키로 사용한 만큼만 비용 발생 — 구독료나 숨은 비용 없음.
---
...
1. **앱 다운로드**: 사용 중인 플랫폼(macOS 또는 Windows)에 맞는 설치 파일 다운로드
...
### 🔒 **프라이버시 우선**
모든 메모리, 로그, 설정이 로컬에 저장됩니다. Claude API와 직접 통신하며 중간 서비스가 없습니다. 데이터가 제3자 서버를 거치지 않습니다.
